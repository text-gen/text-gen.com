...
-   Added ability to generate templates to clipboard instead of directly inserting the result into the editor([#73](https://github.com/nhaouari/obsidian-textgenerator-plugin/issues/73)).
-   Added the ability to assign hotkeys for each template command (generate, generate&create, insert, insert&create, model, and clipboard) ([#71](https://github.com/nhaouari/obsidian-textgenerator-plugin/issues/71)).
...
-   Enhanced suggestion display for better user experience.
